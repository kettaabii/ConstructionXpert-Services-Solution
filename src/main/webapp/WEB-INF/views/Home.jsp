    ...
    <header class="header">
        ...
        <div class="header__info">
            <div class="header__info--description">
                ...
                <p>
                    Build <strong style="text-decoration: #f6f6f9">Right</strong> And concrete
                </p>
                <div class="header__buttons">
                    <a href="login">
                    <button class="btn btn-black">Login</button></a>
                <a href="https://github.com/kettaabii/ConstructionXpert-Services-Solution">
