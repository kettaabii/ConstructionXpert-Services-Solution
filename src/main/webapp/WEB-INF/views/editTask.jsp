...
<div class="container">
    ...
    <main>
        ...
        <div class="main-container" >
            <h1 style="background-color: #f36f2e;"> Task informations :</h1>
            <form action="EditTask" method="post"  >
                <div class="projectForm" style="display: flex;gap:3rem;border: 1px solid #f36f2e; ">
                    <div class="left_info_form" style="margin: 1rem;">
                        <input hidden="hidden" type="number" id="taskId" name="taskId" value="${task.idTask}"><br>
                        <input hidden="hidden" type="number" id="assignedEmployeeId" name="assignedEmployeeId" value="${task.assignedEmployeeId}"><br>

                        <label for="tasktitle">Task Name:</label><br>
                        <input type="text" id="tasktitle" name="tasktitle" value="${task.title}"><br>

                        <label for="dateDebutTache">Start Date:</label><br>
                        <input type="date" id="dateDebutTache" name="dateDebutTache" value="${task.dateDebutTache}"><br>

                        <label for="dateFinTache">End Date:</label><br>
                        <input type="date" id="dateFinTache" name="dateFinTache" value="${task.dateFinTache}"><br>
                    </div>
                    <div class="right_info_form" style="margin: 1rem;">

                        <label for="description">Description:</label><br>
                        <input type="text" id="description" name="description" value="${task.description}" rows="4" cols="35" ></input><br>
                        <label for="status">Status:</label><br>
                        <select id="status" name="status" value="${task.status}">
                            <option value="A_FAIRE">To DO</option>
                            <option value="EN_COURS">STARTED</option>
                            <option value="FAITE">DONE</option>
                        </select>
                    </div>
                    <div class="form-footer" style="display: flex; justify-content: right; gap:2rem;padding: 3rem;">
                        <a href="deleteTask?taskId=${task.idTask}"> <input  type="button" style="display: inline-block;color: #ffffff; text-align: center;vertical-align: middle;  border: 1px solid transparent;  background: lightcoral;  font-size: 1rem;  line-height: 1.5;  cursor: pointer;  width: 8rem;  height: 2rem;border-radius: 50px;" value="DELETE "></a>
                        <input style="display: inline-block;color: #ffffff; text-align: center;vertical-align: middle;  border: 1px solid transparent;  background: #f36f2e;  font-size: 1rem;  line-height: 1.5;  cursor: pointer;  width: 8rem;  height: 2rem;border-radius: 50px;" type="submit" value="Submit">
