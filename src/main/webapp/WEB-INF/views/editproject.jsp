            ...
            <form action="Editproject" method="post"  >
                <div class="projectForm" style="display: flex;gap:3rem;border: 1px solid #f36f2e; ">
                    <div class="left_info_form" style="margin: 1rem;">
                        <input hidden="hidden" type="number" id="idProject" name="idProject" value="${project.id}"><br>
                        <label for="projectName">Project Name:</label><br>
                        <input type="text" id="projectName" name="projectName" value="${project.projectName}"><br>

                        <label for="startDate">Start Date:</label><br>
                        <input type="date" id="startDate" name="startDate" value="${project.dateDebut}"><br>

                        <label for="endDate">End Date:</label><br>
                        <input type="date" id="endDate" name="endDate" value="${project.dateDebut}"><br>
                    </div>
                    <div class="right_info_form" style="margin: 1rem;">

                        <label for="description">Description:</label><br>
                        <input type="text" id="description" name="description" value="${project.description}" rows="4" cols="35" ></input><br>
                        <label for="budget">Budget:</label><br>
                        <input type="number" id="budget" name="budget" value="${project.budget}"><br><br>
                    </div>
                    <div class="form-footer" style="display: flex; justify-content: right; gap:2rem;padding: 3rem;">
                        <a href="deleteProject?projectId=${project.id}"> <input  type="button" style="display: inline-block;color: #ffffff; text-align: center;vertical-align: middle;  border: 1px solid transparent;  background: lightcoral;  font-size: 1rem;  line-height: 1.5;  cursor: pointer;  width: 8rem;  height: 2rem;border-radius: 50px;" value="DELETE "></a>
