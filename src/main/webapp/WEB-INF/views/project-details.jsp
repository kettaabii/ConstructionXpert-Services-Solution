        ...
        <div class="main-container">
            ...
            <div class="ressource-container" style="border:1px solid orange;border-radius: 6px;display: flex; flex-direction: column; gap:1rem;">
                ...
                <div class="project-bottom" style="display: flex;justify-content:right; padding: 1rem;" >
                    <input type="button" style="display: inline-block;color: #ffffff; text-align: center;vertical-align: middle;  border: 1px solid transparent;  background: #f36f2e;  font-size: 1rem;  line-height: 1.5;  cursor: pointer;  width: 8rem;  height: 2rem;border-radius: 50px;" value="Edit ">
                </div>
